                ...
                <div className="bg-white rounded-2xl shadow-md overflow-hidden">
                    ...
                    {filteredCourses.length > 0 && (
                        <div className="block md:hidden p-4 space-y-4">
                            {filteredCourses.map((course) => (
                                <div key={course._id} className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                    <div className="flex justify-between items-start mb-3">
                                        <div>
                                            <h3 className="font-semibold text-slate-800 text-sm">
                                                {course.title}
                                            </h3>
                                            <p className="text-xs text-indigo-600 font-bold mt-1">{course.courseCode}</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mb-3">
                                        <div className="bg-white rounded-lg p-3 border">
                                            ...
                                            <p className="font-medium text-slate-800 text-sm">{course.department}</p>
                                        </div>
                                        <div className="bg-white rounded-lg p-3 border">
                                            <p className="text-xs text-slate-500 mb-1">Credits</p>
                                            <p className="font-medium text-slate-800 text-sm">{course.credits}</p>
                                        </div>
                                    </div>

                                    <div className="mb-3">
                                        <p className="text-xs text-slate-500 mb-2">Faculty</p>
                                        {course.faculty ? (
                                            ...
                                            <div className="bg-slate-50 rounded-lg p-3 border border-dashed">
